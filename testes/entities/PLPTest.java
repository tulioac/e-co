...
class PLPTest {
	...
	void testaConstrutor() {
		new PLP("1/2005","111111000-1", 2005, "Destina 30% das muultas de trânsito arrecadadas à melhoria da acessibilidade urbana",
	...
	@Test
	void testaToString() {
		assertEquals("Projeto de Lei Complementar - PLP 10/2019 - " +
                "111111111-1 - Reduz a tributacao em cima de bicicletas - " +
                "123, 12 - EM VOTAÇÃO (CCJC)", this.plp.toString());
	}
