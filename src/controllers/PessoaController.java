...
/**
 * Essa classe usa o padrao Controller contendo metodos 
 * que operam sobre a classe pessoa.
 * 
...
public class PessoaController {
	/**
	 * Armazena um mapa de pessoas em que a chave 
	 * e o documento de identificacao e aponta
	 * para um objeto do tipo Pessoa.
	 */
	private Map<String, Pessoa> pessoas;

	/**
	 * Constroi uma classe controladora de pessoa e 
	 * inicializa um mapa que armazena as pessoas.
	 */
	...
	/**
	 * Esse metodo valida uma string testando se e 
	 * nula ou vazia. 
	...
	/**
	 * Esse metodo valida se o documento nacional de 
	 * identificacao da pessoa esta no formato correto.
	...
	/**
	 * Esse metodo cadastra uma pessoa que possui nome, 
	 * documento de identificacao, estado, interesses e 
	 * partido.
	...
	/**
	 * Esse metodo cadastra uma pessoa que possui nome, 
	 * documento de identificacao, estado e interesses.
	 * @param nome nome da pessoa
	 * @param dni documento de identificacao da pessoa
	 * @param estado estado da pessoa
	 * @param interesses interesses da pessoa
