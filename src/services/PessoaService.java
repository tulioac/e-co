...
public class PessoaService {
	...
	/**
	 * Retorna um Set de objetos Pessoa. Obtém um grupo de todas as Pessoas cadastradas no
	 * sistema.
	 * 
	 * @return Set de Pessoa contendo todas as pessoas que foram cadastradas no sistema até o momento
	 */
	...
	/**
	 * Retorna booleano sobre o fato de uma Pessoa estar ou não cadastrada no sistema.
	 * 
	...
	/**
	 * Retorna um booleano sobre o fato de uma Pessoa com o dni passado possuir ou não o cargo de deputado.
	 * 
	 * @param dni String contendo o dni da Pessoa que se quer consultada
	 * @return true para quando a pessoa com o dni passado possuir o cargo de Deputado, false caso contrário
	 */
